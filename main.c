...
int main() {
    ...
    switch (opcao) {
            ...
            case(2):
                ...
                break;
             case(3):
                printf("\n--- DELETAR TAREFA ---\n"); // DELETA A TAREFA QUE O USUARIO DESEJAR
                int posTarefa;
            ...
            case 5:
                ...
                break;
            case 6:
                printf("\n--- FILTRA TAREFAS POR ESTADO ---\n"); // FILTRA AS TAREFAS PELO ESTADO QUE ESTA O ANDAMENTO 
            ...
            case 7:
                printf("\n--- FILTRA TAREFAS POR CATEGORIA ---\n");// FILTRA AS TAREFAS PELA CATEGORIA DESEJADA
                printf("CATEGORIA: ");
                ...
                break;
            case 8:
                printf("\n--- SALVA ARQUIVO POR PRIORIDADE ---\n"); // SALVA O ARQUIVO POR PRIORIDADE QUE O USUARIO ESCREVER
                printf("PRIORIDADE: ");
            ...
            case 9:
                printf("\n--- SALVA ARQUIVO POR CATEGORIA ---\n");// SALVA O ARQUIVO POR CATEGORIA EM QUE O USARIO DIGITAR
                printf("CATEGORIA: ");
                ...
                break;
            case 10:
                printf("\n--- FILTRAR POR CATEGORIA E PRIORIDADE ---\n");// FILTRA A TAREFA POR CATEGORIA E PRIORIDADE
                printf("CATEGORIA: ");
            ...
            case 11:
                ...
                break;
            case(0):
                printf("\nVOCE ESCOLHEU SAIR.\n");// AO CLICAR NA OPCAO ZERO, O USUARIO IRA SAIR
                salvar(tam, lt);
